...
Revision ID: 1807927097f9
Revises: e7cc6e96fb27
Create Date: 2023-09-22 23:51:00.794332
...
revision = '1807927097f9'
down_revision = 'e7cc6e96fb27'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('users', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('last_since', sa.DateTime(), nullable=True))
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('users', schema=None) as batch_op:
        batch_op.drop_column('last_since')
